...
```Bash
cd inference-tutorials-generic/car_detection_tutorial
```
...
```Bash
svn export https://github.com/intel-iot-devkit/inference-tutorials-generic.git/trunk/car_detection_tutorial
```
