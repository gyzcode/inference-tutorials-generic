...
```Bash
cd inference-tutorials-generic/face_detection_tutorial
```
...
```Bash
svn export https://github.com/intel-iot-devkit/inference-tutorials-generic.git/trunk/face_detection_tutorial
```
